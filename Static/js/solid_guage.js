// d3.json('../../Data/covidSummary.json').then((data) =>{
//     console.log(data)
//     var toDeaths=data['Total Deaths'][0]
//     var toRecovered=data['Total Recovered'][0]
//     var toHosp=data['Total Hospitalized'][0]
//     var toPos=data['Total Positives'][0]
// }
// );
// Create root element
